...
return new class extends Migration {
     ...
     * order_id: Liên kết với tb_orders
     * product_id: Liên kết với tb_products
    ...
    public function up(): void
    {
        Schema::create('tb_order_details', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('order_id'); // Liên kết với tb_orders
            $table->unsignedBigInteger('product_id'); // Liên kết với tb_products
    ...
    /**
     * Reverse the migrations by dropping the 'tb_order_details' table.
     */

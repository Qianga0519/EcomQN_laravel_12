                            ...
                            <div class="thumbnail-images">
                                <div class="swiper-thumbnail-images">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide thumbnail-item"
                                            data-img="./assets/images/cate-laptop.webp">
                                        ...
                                        <div class="swiper-slide thumbnail-item"
                                            ...
                                            <img src="./assets/images/17580fa67278ff7a25e05b3c310a40e5.png"
                                                class="img-fluid" alt="Product Thumbnail 5">
                                        </div>
                                        <div class="swiper-slide thumbnail-item"
                                            data-img="./assets/images/file-1681987243213.webp">
                                            <img src="./assets/images/file-1681987243213.webp" class="img-fluid"
                    ...
                    <div class="col-md-6">
                        <div class="product-info">
                            ...
                            <div class="product-price mb-3">
                                ...
                                <span
                                    class="original-price text-decoration-line-through ms-2 text-muted">29.990.000₫</span>
                            ...
                            <div class="product-quantity mb-4">
                                ...
                                <div class="quantity-selector d-flex align-items-center">
                                    ...
                                    <input type="number" class="form-control text-center mx-2" id="quantity" value="1"
                ...
                <ul class="nav nav-tabs" id="productTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews"
                            type="button" role="tab" aria-controls="reviews" aria-selected="false">Reviews (87)</button>
                    </li>
                </ul>

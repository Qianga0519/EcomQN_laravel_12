...
<div class="col-md-9" style="font-size: .775rem;">
    ...
    <div class="options d-flex justify-content-between align-items-center bg-white p-3 rounded shadow-sm mb-4">
        ...
        <div class="sort-options d-flex align-items-center gap-1">
            ...
            <div class="view-options ms-3 d-flex gap-1">
                <button class="btn btn-sm btn-outline-secondary active"><i class="bi bi-grid-3x3-gap-fill"></i></button>
    ...
    <div class="row g-3 product-grid">
        ...
        <div class="col-6 col-sm-4 col-xl-3">
            <a href="product-detail.html" class="card text-left product-item text-decoration-none">
                ...
                <img class="card-img-top" src="assets/images/X14-PR-Banner1708935529-0.png" alt="Samsung Galaxy S25" />
